...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    }, 150); // التحكم في سرعة الكتابة هنا
    ...
    <>
      ...
      <div className="text-3xl font-bold hidden md:block arabic-text">المدينه للزجاج</div>
        ...
        <div className={`toggle ${menuOpen ? 'block' : 'hidden'} w-full md:w-auto md:flex text-right mt-5 md:mt-0`}>
          <a href="#home" className="block md:inline-block hover:text-blue-500 px-3 py-3">الصفحه الرئيسيه</a>
          <a href="./ourserve.jsx" className="block md:inline-block hover:text-blue-500 px-3 py-3">خدماتنا</a>
          <a href="#contactUs" className="block md:inline-block hover:text-blue-500 px-3 py-3">موقعنا</a>
        </div>
